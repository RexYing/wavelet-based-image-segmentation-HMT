...
\begin{frame}
  ...
  \begin{itemize}
    \item Normal text
    \item \highlighttext{Highlighted text} to draw attention
    ...
    \begin{itemize}%[label=$\star$]
      ...
      \highlighttext{\item Or ``Highlight'' it}
    \end{itemize}
  \end{itemize}
  \end{block}
...
%   \end{enumerate}
   \begin{enumerate}
    \item Two more to go \pause
    \item One more to go \pause
    \item Last chance... \pause
    \item BOOM! \pause
  \end{enumerate}
  \end{block}
